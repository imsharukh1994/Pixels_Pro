...
class MainActivity : AppCompatActivity(){
    ...
    fun hidenav(){
        ...
        navbox?.animate().apply {
            ...
            BottomLoading.loctionbottom = 1000;
            this.withEndAction {
    ...
    fun setFABcolor(icon : menu){
        ...
        reddit_floatingButton?.setImageResource(R.drawable.reddit_ic);
        when (icon){
            menu.reddit ->{
                reddit_floatingButton?.imageTintList = ColorStateList.valueOf(resources.getColor(R.color.Selected,theme));
                reddit_floatingButton?.setImageResource(R.drawable.reddit_looking_up);
            }
            menu.wallhaven ->{
