...
class wallhaven_posts( menuChange : MainActivity.MenuChange? = null) : Fragment() , Image_list_adapter.OnImageClick{
     ...
     var bottomloading : BottomLoading.ViewLodMore? = null;
    ...
    private fun SetRvScrollListener(){
        bottomloading =   BottomLoading.ViewLodMore(mLayoutManager as StaggeredGridLayoutManager, MenuChange);
        bottomloading!!.setOnLoadMoreListener(object : BottomLoading.OnLoadMoreListener {
