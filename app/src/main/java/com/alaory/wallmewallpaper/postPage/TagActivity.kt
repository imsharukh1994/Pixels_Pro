...
class TagActivity : AppCompatActivity(), Image_list_adapter.OnImageClick {
    ...
    private var scrolllistener : BottomLoading.ViewLodMore? = null;
    ...
    private fun setScrollListenerForRv(){
        scrolllistener = BottomLoading.ViewLodMore(MlaoutManager as StaggeredGridLayoutManager,null);
        scrolllistener!!.setOnLoadMoreListener(object : BottomLoading.OnLoadMoreListener {
